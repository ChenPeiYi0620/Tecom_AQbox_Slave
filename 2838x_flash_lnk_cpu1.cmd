...
MEMORY
{
   ...
   RAMGS6_15          : origin = 0x013000, length = 0x009000
...
SECTIONS
{
   ...
   .ebss            : > RAMLS5 | RAMGS0 | RAMGS1 | RAMGS2 | RAMGS3 | RAMGS4 | RAMGS6_15
   .esysmem         : > RAMLS5
   .cio             : > RAMLS5
   /* Initalized sections go in Flash */
   .econst          : >> FLASH4 | FLASH5, ALIGN(4)
#endif
// data section for variables in ram (cleaned on reset)
   ramdata : > RAMGS6_15
   ...
   .TI.ramfunc            : LOAD = FLASH3,
                         RUN = RAMLS0 | RAMLS1 | RAMLS2 |RAMLS3 | RAMGS6_15,
